...
import pandas as pd
from System.Workplace.workplace import pred_values, actual_values, mask, pred_df, item_user_ratings_df
...
def recommend_movies_based_on_user(user_id, num_recommended_movies):
    ...
    movies_watched = ratings_pivot_table.loc[1][ratings_pivot_table.loc[1] > 0].index.tolist()
    ...
    for m in ratings_pivot_table.columns[ratings_pivot_table.loc[1] == 0].tolist():
